...
class Level3FlagActivity : AppCompatActivity() {
    ...
    private val questions = listOf(
        Question(R.drawable.az, "Азербайджан", "Грузия", "Казахстан", "Армения", 1),
        Question(R.drawable.eng, "Уэльс", "Англия", "Шотландия", "Ирландия", 2),
        Question(R.drawable.be, "Нидерланды", "Люксембург", "Бельгия", "Франция", 3),
        Question(R.drawable.dk, "Швеция", "Норвегия", "Финляндия", "Дания", 4),
        Question(R.drawable.eg, "Египет", "Марокко", "Алжир", "Тунис", 1),
        Question(R.drawable.il, "Сирия", "Израиль", "Иордания", "Ливан", 2),
        Question(R.drawable.ir, "Турция", "Саудовская Аравия", "Ирак", "Иран", 4),
        Question(R.drawable.co, "Аргентина", "Бразилия", "Колумбия", "Перу", 3),
        Question(R.drawable.mx, "Мексика", "Гватемала", "Куба", "Панама", 1),
        Question(R.drawable.no, "Норвегия", "Швеция", "Исландия", "Финляндия", 1)
    )
