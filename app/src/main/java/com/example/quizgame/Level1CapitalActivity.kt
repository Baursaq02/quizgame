...
class Level1CapitalActivity : AppCompatActivity() {
    ...
    private val questions = listOf(
        Question("Канада", "Оттава", "Москва", "Вашингтон", "Пекин", 1),
        Question("Россия", "Париж", "Москва", "Токио", "Берлин", 2),
        Question("США", "Лондон", "Рим", "Вашингтон", "Мадрид", 3),
        Question("Китай", "Пекин", "Сеул", "Канберра", "Дели", 1),
        Question("Франция", "Париж", "Лиссабон", "Хельсинки", "Варшава", 1),
        Question("Италия", "Мадрид", "Рим", "Афины", "Вена", 2),
        Question("Турция", "Анкара", "Стамбул", "Тегеран", "Баку", 1),
        Question("Япония", "Токио", "Сеул", "Бангкок", "Сингапур", 1),
        Question("Германия", "Берлин", "Цюрих", "Вена", "Прага", 1),
        Question("Великобритания", "Лондон", "Эдинбург", "Дублин", "Кардифф", 1)
    )
