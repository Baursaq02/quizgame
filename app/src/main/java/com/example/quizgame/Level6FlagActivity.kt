...
class Level6FlagActivity : AppCompatActivity() {
    ...
    private val questions = listOf(
        Question(R.drawable.mv, "Мальдивы", "Сейшелы", "Бали", "Маврикий", 1),
        Question(R.drawable.ge, "Грузия", "Армения", "Азербайджан", "Турция", 2),
        Question(R.drawable.ma, "Марокко", "Алжир", "Тунис", "Египет", 1),
        Question(R.drawable.kp, "Северная Корея", "Южная Корея", "Китай", "Япония", 1),
        Question(R.drawable.tm, "Туркменистан", "Узбекистан", "Казахстан", "Таджикистан", 1),
        Question(R.drawable.tr, "Турция", "Греция", "Италия", "Болгария", 1),
        Question(R.drawable.uy, "Уругвай", "Парагвай", "Аргентина", "Бразилия", 1),
        Question(R.drawable.lu, "Люксембург", "Бельгия", "Нидерланды", "Швейцария", 1),
        Question(R.drawable.ke, "Кения", "Эфиопия", "Танзания", "Уганда", 1),
        Question(R.drawable.mg, "Мадагаскар", "Сейшелы", "Коморы", "Маврикий", 1)
    )
